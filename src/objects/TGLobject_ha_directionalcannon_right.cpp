...
void TGLobject_ha_directionalcannon_right::draw(glm::mat4 transform, class GLTManager *GLTM)
{
	if (m_state==0) m_last_tile=GLTM->get("graphics/objects/ha-directionalcannon1.png");
	if (m_state==1) m_last_tile=GLTM->get("graphics/objects/ha-directionalcannon1.png");
	if (m_state>124) m_last_tile=GLTM->get("graphics/objects/ha-directionalcannon2.png");
	if (m_state>120 && m_state<=124) m_last_tile=GLTM->get("graphics/objects/ha-directionalcannon3.png");
	if (m_state>116 && m_state<=120) m_last_tile=GLTM->get("graphics/objects/ha-directionalcannon2.png");
	if (m_state>1 && m_state<=116) m_last_tile=GLTM->get("graphics/objects/ha-directionalcannon1.png");
    if (m_last_tile!=0) {
