...
void TGLobject_ship_shadowrunner::draw(glm::mat4 transform, class GLTManager *GLTM)
{
	if (m_last_mask==0) m_last_mask=GLTM->get("graphics/objects/ship-srunner-1.png");

	if (!m_thrusting && !m_backthrusting) {
		m_last_tile=GLTM->get("graphics/objects/ship-srunner-1.png");
	} // if 
	if (m_thrusting && !m_backthrusting) {
		if (((m_cycle/4)%2)==0) m_last_tile=GLTM->get("graphics/objects/ship-srunner-2.png");
						   else m_last_tile=GLTM->get("graphics/objects/ship-srunner-3.png");
	} // if 
	if (!m_thrusting && m_backthrusting) {
		if (((m_cycle/4)%2)==0) m_last_tile=GLTM->get("graphics/objects/ship-srunner-4.png");
						   else m_last_tile=GLTM->get("graphics/objects/ship-srunner-5.png");
	} // if 
	if (m_thrusting && m_backthrusting) {
		if (((m_cycle/4)%2)==0) m_last_tile=GLTM->get("graphics/objects/ship-srunner-6.png");
						   else m_last_tile=GLTM->get("graphics/objects/ship-srunner-7.png");
	} // if 
