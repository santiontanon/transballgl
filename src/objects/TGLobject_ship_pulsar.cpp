...
void TGLobject_ship_pulsar::draw(glm::mat4 transform, class GLTManager *GLTM)
{
	if (m_last_mask==0) m_last_mask=GLTM->get("graphics/objects/ship-pulsar-1.png");

	if (m_thrusting) {
		if (((m_cycle/4)%2)==0) m_last_tile=GLTM->get("graphics/objects/ship-pulsar-2.png");
						   else m_last_tile=GLTM->get("graphics/objects/ship-pulsar-3.png");
	} else {
		m_last_tile=GLTM->get("graphics/objects/ship-pulsar-1.png");
	} // if 
